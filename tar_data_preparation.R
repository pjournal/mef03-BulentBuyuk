...
download.file("https://www.tarimorman.gov.tr/BUGEM/Belgeler/Bitkisel%20%C3%9Cretim/Organik%20Tar%C4%B1m/%C4%B0statistikler/2014/2014%20Organik%20Tar%C4%B1msal%20%C3%9Cretim%20Verileri.xlsx",destfile=tmp, mode="wb")
raw_tar_14<-readxl::read_excel(tmp,col_names=FALSE,skip=1)
file.remove(raw_tar_14)

tmp_15<-tempfile(fileext=".xlsx")
download.file("https://www.tarimorman.gov.tr/BUGEM/Belgeler/Bitkisel%20%C3%9Cretim/Organik%20Tar%C4%B1m/%C4%B0statistikler/2015/2015%20Organik%20Tar%C4%B1msal%20%C3%9Cretim%20Verileri.xlsx",destfile=tmp, mode="wb")
raw_tar_15<-readxl::read_excel(tmp,col_names=FALSE,skip=1)
file.remove(raw_tar_15)

tmp_16<-tempfile(fileext=".xlsx")
download.file("https://www.tarimorman.gov.tr/BUGEM/Belgeler/Bitkisel%20%C3%9Cretim/Organik%20Tar%C4%B1m/%C4%B0statistikler/2016/2016%20Organik%20Tar%C4%B1msal%20%C3%9Cretim%20Verileri.xlsx",destfile=tmp, mode="wb")
raw_tar_16<-readxl::read_excel(tmp,col_names=FALSE,skip=1)
file.remove(raw_tar_16)

tmp_17<-tempfile(fileext=".xlsx")
download.file("https://www.tarimorman.gov.tr/BUGEM/Belgeler/Bitkisel%20%C3%9Cretim/Organik%20Tar%C4%B1m/%C4%B0statistikler/2017/2017%20Organik%20Tar%C4%B1msal%20%C3%9Cretim%20Verileri%20(005).xlsx",destfile=tmp, mode="wb")
raw_tar_17<-readxl::read_excel(tmp,col_names=FALSE,skip=1)
file.remove(raw_tar_17)

tmp_18<-tempfile(fileext=".xlsx")
download.file("https://www.tarimorman.gov.tr/BUGEM/Belgeler/Bitkisel%20%C3%9Cretim/Organik%20Tar%C4%B1m/%C4%B0statistikler/2018/2018%20Organik%20Tar%C4%B1msal%20%C3%9Cretim%20Verileri.xlsx",destfile=tmp, mode="wb")
raw_tar_18<-readxl::read_excel(tmp,col_names=FALSE,skip=1)
...
glimpse(tar_data)
save(tar_data, file = "tar_data.RData")
